---
layout: post
title: "Benchmarking Supervised and Self-Supervised Mortality Risk Prediction Models on ECG Data"
type: post
date: 2026-03-01
tags:
  - ML in Healthcare
...
- Pretrained benchmark models adapted from [cavalab/ecg-survival-benchmark](https://github.com/cavalab/ecg-survival-benchmark)
- HuBERT-ECG architecture based on self-supervised pretraining research [HuBERT-ECG as a Self-Supervised Foundation Model for Broad and Scalable Cardiac Application](https://github.com/Edoar-do/HuBERT-ECG)
